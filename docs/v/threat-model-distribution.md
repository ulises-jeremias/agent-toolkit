...
| Launcher reimplements CLI in Python | High | Product scripts call launcher only; Python CLI removed v1.13.0 ([python-fallback.md](python-fallback.md)) | Wheel is trampoline + binary + data only |
