...
You should see the assistant skill instructions load. Browse the full catalog: `catalogs/skill-catalog.yaml` (116+ skills), regenerate with `./scripts/generate-catalogs.vsh`.
