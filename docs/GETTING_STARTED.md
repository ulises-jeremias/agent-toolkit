...
You should see the assistant skill instructions load. Browse the full catalog: `catalogs/skill-catalog.yaml` (77 skills), regenerate with `./scripts/generate-catalogs.vsh`.
