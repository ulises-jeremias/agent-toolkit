...
Skills live under `skills/<domain>/<name>/`. There are **14 domains** (116+ skills). Membership in marketplace products is a subset — see [`SKILL_PRODUCT_MATRIX.md`](SKILL_PRODUCT_MATRIX.md) and `agent-toolkit inventory`.
