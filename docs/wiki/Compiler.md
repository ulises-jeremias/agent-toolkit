...
The compiler lives in the **V** CLI (`v run make.vsh build-cli` → `build/agent-toolkit`). Python adapters under `packages/pypi/` are launcher/parity tests, not the product path.
