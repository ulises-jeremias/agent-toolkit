...
Counts: 80 skills (14 domains), 17 agents, 10 loops, 7 packs, 7 MCP templates, 7 profiles. Live inventory: `agent-toolkit inventory` / `catalogs/`.

```
agent-toolkit/
├── skills/                      # 80 SKILL.md trees (14 domains)
