...
└── scripts/            # validate-skills.vsh, validate-agents.vsh, generate-catalogs.vsh, gen-surfaces.vsh (provenance.py kept)
```
...
- Modify `catalogs/` manually — these are generated by `v run scripts/generate-catalogs.vsh`
