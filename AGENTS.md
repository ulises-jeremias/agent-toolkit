...
- Modify `catalogs/` manually — these are generated by `python3 scripts/generate-catalogs.py --check`
...
```bash
python3 scripts/generate-catalogs.py          # regenerate catalogs/*.yaml
python3 scripts/generate-catalogs.py --check  # fail if committed catalogs drifted
```
