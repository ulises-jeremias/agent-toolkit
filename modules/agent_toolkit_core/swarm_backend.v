...
pub fn runner_available(name string) bool {
	bin := match name {
		'opencode' { 'opencode' }
		'claude' { 'claude' }
		'codex' { 'codex' }
...
pub fn swarm_model_profiles() map[string]map[string]string {
	return {
		'economy':  {
			'opencode': 'haiku'
			'claude':   'haiku'
