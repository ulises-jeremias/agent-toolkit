...
def _install_claude_code(*, dry_run: bool, force: bool) -> bool:
    ...
    root = toolkit_root()
    src = root / "profiles" / "claude-code"
    tracker = InstallTracker("claude-code", dry_run=dry_run, toolkit_root=root)
...
def _install_cursor(*, dry_run: bool, force: bool) -> bool:
    ...
    root = toolkit_root()
    src = root / "profiles" / "cursor" / "rules"
...
def _install_opencode(*, dry_run: bool, force: bool) -> bool:
    ...
    root = toolkit_root()
    src = root / "profiles" / "opencode"
    tracker = InstallTracker("opencode", dry_run=dry_run, toolkit_root=root)
...
def _install_windsurf(*, dry_run: bool, force: bool) -> bool:
    ...
    root = toolkit_root()
    src = root / "profiles" / "windsurf"
    tracker = InstallTracker("windsurf", dry_run=dry_run, toolkit_root=root)
...
def _install_pi(*, dry_run: bool, force: bool) -> bool:
    ...
    root = toolkit_root()
    src = root / "profiles" / "pi" / "skills"
    tracker = InstallTracker("pi", dry_run=dry_run, toolkit_root=root)
