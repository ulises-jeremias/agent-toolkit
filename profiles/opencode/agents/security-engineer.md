---
description: Security hardening specialist — app + agentic security, threat modeling, supply-chain/MCP audit, SARIF triage. Use when: security-sensitive PR/endpoint, agentic/MCP/plugin change, supply-chain before adoption, STRIDE/threat model, or CodeQL/SARIF triage.
mode: subagent
color: secondary
permission:
  bash: allow
