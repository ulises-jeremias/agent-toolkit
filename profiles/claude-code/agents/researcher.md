---
name: researcher
description: 'Research and discovery specialist — spike findings, evidence-intake,
  framework/docs exploration, inventory, reference examples. Use when: unknown needs
  time-boxed investigation, implementation strategy/risks/tradeoffs, upstream/framework
  docs lookup, project-assessment evidence map, or discovering installed toolkit capabilities.'
