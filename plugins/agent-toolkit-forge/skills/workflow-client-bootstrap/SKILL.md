...
Use **`workflow-client-bootstrap`** going forward:

- Path: `~/.local/share/agent-toolkit/skills/workflow-client-bootstrap/`
- Catalog: `skill-catalog.yaml` (preferred entry point)
