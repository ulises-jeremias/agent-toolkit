...
- Escalated maintainability / structural review → `quality/deep-review` (thermos-inspired rubric; load when user asks for deep or architecture-heavy review)
- CI failures blocking merge → `forge/gh-fix-ci` (log triage; plan before coding)
